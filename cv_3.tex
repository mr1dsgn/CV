...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Position}{CEO}{}
	\tableentry{Employer}{VDIS}{}
	...
	\tableentry{}{\textbf{Magda B. Fayek}}{Scientist}
	\tableentry{Position}{Professor}{}
	\tableentry{Employer}{Cairo Universty}{Artificial Intelligence}
	\tableentry{Email}{magdafayek@ieee.org}{\href{mailto:magdafayek@ieee.org}}
...
\parbox[top][0.12\textheight][c]{\linewidth}{ % Parbox to hold the colour box; fixed height to match the name/CV text to the left, centred vertically and full line width
	...
	\colorbox{shade}{ % Create the coloured box
		\begin{supertabular}{p{0.05\linewidth}|p{0.775\linewidth}} % Start a table with two columns, the table will ensure everything is aligned
			...
			\raisebox{-1pt}{\faPhone} & +20 (10) 2323-0221 \\ % Phone number
			\raisebox{0pt}{\small\faEnvelope} & \href{mailto:a.ezzat@vdis-eg.com}{a.ezzat@vdis-eg.com} \\ % Email address
...
\longformdescription{Programming Techniques}{Multi tier, OOP, MVC, Data flow, Functional, RTOS}\\
\longformdescription{Programming Languages}{C98, C99, ANSI C, C11, CUDA C C++11, C++17, Python, C\#, JAVA, LabVIEW, LADDER, Structured text, Swift}\\
